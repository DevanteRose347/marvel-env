...
class ProductForm(FlaskForm):
    ...
    edition = StringField("Product edition", validators=[DataRequired()])
    comic_book = StringField("Product comic_book", validators=[DataRequired()])
    movie = StringField("Product movie", validators=[DataRequired()])
